 ...
 * 书架管理 - 旧版本
 * 
 * @deprecated 此文件已被 library.ts 替代，但仍被多个 UI 组件使用
 * @see src/core/library.ts - 新的书架管理系统
 * 
 * 当前状态: 保留用于向后兼容
 * 使用位置: Bookshelf.vue, Settings.vue, BookSearch.vue, ReaderToc.vue, main.ts
 * 
 * TODO: 逐步迁移 UI 组件到 library.ts
 */
